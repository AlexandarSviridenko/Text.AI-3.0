...
double antiPlagiarism(string text, string fragment)
{
	...
	textDatabaseLength = editingTextDatabase(textDatabase);
	userTextLength = editingUserText(userText);
	uniqueness = calculateUniqueness(textDatabaseLength, userTextLength);
}
